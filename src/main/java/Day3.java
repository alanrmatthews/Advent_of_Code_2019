...
public class Day3 {
    ...
    public static void main(String[] args) {
        System.out.println("Part 1 Distance: " + getDistance(Wire1, Wire2));
    }

    public static int getDistance(String[] path1, String[] path2) {
        HashSet<IntPair> parsedPath1 = parsePath(path1);
        HashSet<IntPair> parsedPath2 = parsePath(path2);

        HashSet<IntPair> commonPoints = new HashSet<>(parsedPath1);
    ...
    private static HashSet<IntPair> parsePath(String[] path) {
        HashSet<IntPair> output = new HashSet<>();
